...
module Dict
	def Dict.new(num_buckets=256)
		# Initializes a Dict wit the given number of bucktts.
		aDict = []
	...
	def Dict.hash_key(aDict, key)
		...
		# an index for the aDict's bucktrs.
	...
	def Dict.set(aDict, key, value)
		# Sets the key to the value, replacing any existing valut.
		bucket = Dict.get_bucket(aDict, key)
